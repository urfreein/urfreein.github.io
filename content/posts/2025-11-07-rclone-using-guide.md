...
date: 2025-11-07 11:44:00 +0900
categories: [Tech, Utility, Cloud]
tags: [rclone, Windows10, GoogleDrive, CLI, Vultr, CloudStorage, DataTransfer]
excerpt: 저사양 VM 환경에서도 웹 인터페이스 없이 빠르고 간편하게 rclone을 사용하여 구글 드라이브 파일을 관리하는 방법을 다운로드부터 업로드/다운로드까지 단계별로 안내합니다.
---
